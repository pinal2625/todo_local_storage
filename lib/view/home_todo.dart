...
import 'package:todo_local_storage/model/to_do_modal.dart';
import 'package:todo_local_storage/res/common/button.dart';
import 'package:todo_local_storage/res/constant/app_strings.dart';
import 'package:todo_local_storage/res/constant/colors.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  setData() {
    ...
    prefs!.setStringList("date", data);
  }

  getData() {
    List<String> data = [];
    data = prefs!.getStringList("date")!;
